...
export 'src/shopping_config.dart';

export 'src/pages/shop_detail_page.dart';
export 'src/pages/product_detail_page.dart';
...
/// controller
export 'src/controller/my_orders_controller.dart';
export 'src/controller/shopping_cart_controller.dart';
