...
Order _$OrderFromJson(Map<String, dynamic> json) {
  ...
  return Order(
    ...
    formatPromoPrice: json['format_promo_price'] as String?,
    ...
    formatTotalPrice: json['format_total_price'] as String?,
    formatPrice: json['format_price'] as String?,
    formatCoast: json['formatCoast'] as String?,
    packageCoast: json['packaging_cost'],
    formatPackageCoast: json['format_packaging_cost'] as String?,
    total: (json['total'] as num?)?.toDouble(),
    formatTotal: json['formatTotal'] as String?,
  );
}
...
Map<String, dynamic> _$OrderToJson(Order instance) => <String, dynamic>{
      ...
      'format_promo_price': instance.formatPromoPrice,
      'discount_type': instance.discountType,
      ...
      'format_total_price': instance.formatTotalPrice,
      'delivery_coast': instance.coast,
      'formatCoast': instance.formatCoast,
      'total': instance.total,
      'formatTotal': instance.formatTotal,
      'packaging_cost': instance.packageCoast,
      'format_packaging_cost': instance.formatPackageCoast,
    };
